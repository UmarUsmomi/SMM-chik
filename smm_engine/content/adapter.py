...
3. Основные пункты: Краткий маркированный список из 2-3 пунктов. Для маркеров используй 🔸. Ключевые термины выделяй **жирным** шрифтом (две звездочки).
...
- НЕ используй HTML теги (никаких <b>, <i>, <blockquote>).
