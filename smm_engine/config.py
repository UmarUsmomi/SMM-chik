...
if CLOUDFLARE_ACCOUNT_ID:
    CLOUDFLARE_ACCOUNT_ID = CLOUDFLARE_ACCOUNT_ID.strip().strip("'\"")

CLOUDFLARE_API_TOKEN = os.getenv("CLOUDFLARE_API_TOKEN")
if CLOUDFLARE_API_TOKEN:
    CLOUDFLARE_API_TOKEN = CLOUDFLARE_API_TOKEN.strip().strip("'\"")
...
# Thresholds
AUTO_PUBLISH_THRESHOLD = int(os.getenv("AUTO_PUBLISH_THRESHOLD", "90"))
